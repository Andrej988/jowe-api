locals {
  ...
  weight_measurements_delete_user_data_lambda_name = var.ENV == "dev" ? "${var.app_name}-api-weight-measurements-delete-user-data-dev" : "${var.app_name}-api-weight-measurements-delete-user-data"
  ...
  weight_targets_delete_user_data_lambda_name      = var.ENV == "dev" ? "${var.app_name}-api-weight-targets-delete-user-data-dev" : "${var.app_name}-api-weight-targets-delete-user-data"

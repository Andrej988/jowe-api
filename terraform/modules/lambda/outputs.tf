output "api_lambdas_names" {
  ...
  value = {
    ...
    weight_measurements_edit             = aws_lambda_function.weight_measurements_edit_lambda.function_name
...
output "api_lambdas_arns" {
  ...
  value = {
    ...
    weight_measurements_edit             = aws_lambda_function.weight_measurements_edit_lambda.invoke_arn
